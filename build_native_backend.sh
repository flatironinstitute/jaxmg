...
for src in cusolvermp_common.cc cusolvermp_common.h cusolvermp_gels.cc cusolvermp_gesvd.cc cusolvermp_lu_solve.cc cusolvermp_polar.cc cusolvermp_potrs.cc cusolvermp_qr.cc cusolvermp_routines.h cusolvermp_syevd.cc potrs_logdet.cu.cc potrs_logdet.h qr_extract.cu.cc qr_extract.h; do
