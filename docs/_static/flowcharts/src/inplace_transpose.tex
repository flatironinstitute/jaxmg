...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[jax]          (rowmajor) at (0,13.40) {Row-major physical order};
  \node[intermediate] (midone)   at (0,9.70)  {Intermediate order I};
  \node[intermediate] (midtwo)   at (0,6.00)  {Intermediate order II};
  \node[ffi]          (colmajor) at (0,2.30)  {Column-major physical order};
