"""Solve a general linear system on a two-column GPU process grid."""
...
def main() -> None:
    ...
    # Construct a nonsymmetric matrix with the known solution x = 1.
    @jax.jit
    def make_problem():
    ...
    x = lu_solve(a, b, T_A=T_A, mesh=mesh, matrix_specs=matrix_specs)
    x.block_until_ready()
    ...
    if jax.process_index() == 0:
        print("LU solution correct:", bool(correct))
