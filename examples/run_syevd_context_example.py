"""Embed an eigendecomposition in a caller-owned JAX compilation."""
...
def main() -> None:
    """Build and solve the distributed matrix inside one jitted function."""
    ...
    # The context interface lets matrix construction and the solve compile together.
    @jax.jit
    def build_and_solve():
        ...
        # Run the JAXMg eigensolver within the caller-owned JIT.
    ...
    eigenvalues, eigenvectors = build_and_solve()
    ...
    if jax.process_index() == 0:
        print("SYEVD context eigenpairs correct:", bool(correct))
