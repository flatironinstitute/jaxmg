...
XLA_FFI_DEFINE_HANDLER_SYMBOL(
    ...
    ffi::Ffi::Bind()
        ...
        .Attr<absl::Span<const int64_t>>("source_rank_map")
        .Attr<absl::Span<const int64_t>>("target_rank_map")
        .Arg<ffi::AnyBuffer>()
        .Arg<ffi::AnyBuffer>()
        .Ret<ffi::AnyBuffer>()
        .Ret<ffi::AnyBuffer>()
...
XLA_FFI_DEFINE_HANDLER_SYMBOL(
    ...
    ffi::Ffi::Bind()
        ...
        .Attr<absl::Span<const int64_t>>("block_rank_map")
        .Attr<absl::Span<const int64_t>>("cyclic_rank_map")
        .Arg<ffi::AnyBuffer>()
        .Arg<ffi::AnyBuffer>()
        .Ret<ffi::AnyBuffer>()
        .Ret<ffi::AnyBuffer>()
